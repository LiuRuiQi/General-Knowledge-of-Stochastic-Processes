...
1.1. 平稳性（“齐次性”）： P<sub>ij</sub>(n,m) = P<sub>ij</sub>(n-m)   (即，重要的是状态转移间的步数)
...
4.1. “可达”(Reachable)： i能到j

4.2. “相通”(Communicative)：i,j能互可达

4.3. “闭集”(Closed Set)： 转移行为一旦进入闭集就出不来了

4.4. “可约”(Reducible)： 某集合存在闭的真子集称为“可约”

4.5. 推论： Markov Chain不可约 <=> 所有状态都相通
